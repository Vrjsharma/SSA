...
import unsw.enrolment.Assignment;
import unsw.enrolment.Assessments;
import unsw.enrolment.Exam;
import unsw.enrolment.Milestone;
import unsw.enrolment.Prac;
import unsw.enrolment.Project;
...
//        comp1511Enrolment.assignMark(65);
        ...
        Assignment assignment1 = new Assignment("Assignment1",20);
        assignment1.setMarks(15);

        // TODO Give the student a passing mark for milestone 1 of assignment 2
        Milestone milestone1 = new Milestone("Milestone1",15);
        milestone1.setMarks(10);
        // TODO Give the student a passing mark for milestone 2 of assignment 2
        Milestone milestone2 = new Milestone("Milestone2",15);
        milestone2.setMarks(10);
        // TODO Give the student an assignment 2 mark which is the average of
        // milestone 1 and 2
        Project assignment2 = new Project("Assignment2",30);
        assignment2.addMilestone(milestone1);
        assignment2.addMilestone(milestone2);

        // TODO Give the student a prac mark which is the sum of assignment 1
        // and 2
        Prac practical = new Prac("Practical",50);
        practical.addAssignments(assignment1);
        practical.addAssignments(assignment2);

        // TODO Give the student a passing exam mark.
        Exam finalExam = new Exam("FinalExam",50);
        finalExam.setMarks(30);
        comp1511Enrolment.assignMark(practical, finalExam);
